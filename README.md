...
│   ├── Assignment 4.2 - Secure AI SDLC & Assurance Readiness.pdf
│   └── Team Assignment 2.1_ Architecture Review Findings.pdf
│
...
License
This repository is licensed under the LICENSE file (typically MIT or similar for academic work — check the file for details). All original work is my own; references to case study materials and tools follow USD program guidelines.
Acknowledgments
...
Contact / Author: Joshua Remington
